...
export class EventsService {
  ...
  async addParticipant(participantId: any, eventId: any): Promise<any> {
    let response = await lastValueFrom(this.http.post(this.eventUrl + '/event/addEventParticipant', {participantId, eventId}));
    return response
  }

  async deleteParticipant(participantId: any, eventId: any): Promise<any> {
    let response = await lastValueFrom(this.http.delete(this.eventUrl + '/event/deleteParticipant/' + eventId + '/' + participantId));
    return response
  }
}
